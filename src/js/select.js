window.selects = select => {
	...
	value.insertAdjacentHTML('beforeend', '<svg width="24" height="24" viewBox="0 0 24 24"><path d="m12 13.17 4.95-4.95 1.41 1.42L12 16 5.64 9.64l1.41-1.42L12 13.17Z"/></svg>');
	select.append(value);
	...
	list.className = 'select__list border';
	listInner.className = 'border__inner';
	...
	[...option].forEach( el => {
		...
		if( el.value !== '' ) {
			...
			control.addEventListener('change', () => {
				...
				select.classList.remove('is-open','is-default');
